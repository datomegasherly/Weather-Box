...
class Weather extends Component {
    ...
    triggerDetails(id) {
        this.setState({showDetails: {...this.state.showDetails , [id]: !this.state.showDetails[id]}});
    }
    hideDetails(id) {
        this.setState({showDetails: {...this.state.showDetails , [id]: false}});
    }
    render() {
                                ...
                                selectedCities.map(city => {
                                    ...
                                    return (
                                        <div key={city.id} className="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                            <div className="float-right mr-2 ml-2 mt-1 close-button" data-test="close-button" 
                                                onClick={() => {
                                                    this.hideDetails(city.id);
                                                    removeCity(city)
                                                }}>
                                            ...
                                            <div className="weather-box-inner container">
                                                {
                                                    weather ?
                                                        <Fragment>
                                                            <div className="row">
                                                                <div className="col-12 weather-country-box">
                                                            ...
                                                            <div className="col-12 row weather-option-box">
                                                                <div className="col-12" onClick={() => this.triggerDetails(city.id)}>Latest Weather Conditions</div>
                                                            </div>
                                                            {
                                                                showDetails[city.id] ?
